...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 26 2018 г., 08:53
...
-- База данных: `cmsdb`
--
CREATE DATABASE `cmsdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cmsdb`;
...
CREATE TABLE IF NOT EXISTS `basket` (
  ...
  `id_basket` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `order_price` int(100) unsigned NOT NULL,
  `payment_method` varchar(255) NOT NULL,
  `date` date NOT NULL,
  PRIMARY KEY (`id_order`),
  KEY `id_user` (`id_user`,`id_basket`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `all_characteristics` text NOT NULL,
  `price` int(11) NOT NULL,
  `num_of_sales` int(11) NOT NULL,
  `type_of_comics` varchar(25) NOT NULL,
  PRIMARY KEY (`id_product`),
  KEY `id_category` (`id_category`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2152 ;

--
-- Дамп данных таблицы `products`
--

INSERT INTO `products` (`id_product`, `id_category`, `name_product`, `characteristics`, `image`, `all_characteristics`, `price`, `num_of_sales`, `type_of_comics`) VALUES
(2001, 1001, 'Бетмен. Убийственная шутка', 'Комикс, который проливает свет на то, как Джокер стал Джокером!', '/img/killingJoke.jpeg', '<p>Комикс, который проливает свет на то, как Джокер стал Джокером! Как заурядный обыватель превратился в самого страшного преступника, какого только знал Готэм, короля преступного мира?</p>\r\n\r\n<p>Сумеет ли Бэтмен остановить Джокера, вознамерившегося затянуть комиссара Гордона и его дочь Барбару в трясину своего убийственного безумия? И смогут ли двое заклятых врагов положить конец своей вечной дуэли, пока не станет поздно?</p>\r\n\r\n<p>«Чтобы превратить самого здравого человека на свете в полного психа, нужен всего один плохой день», — утверждает Джокер. Ну что ж, посмотрим!</p>', 310, 3, 'Detective comics'),
(2002, 1001, 'Бетмен. Возвращение темного рыцаря', 'Писатель и художник Фрэнк Миллер  заново, с чистого листа создал легенду о Бетмене', '/img/theDKreturn.jpeg', '<p>C чистого листа создали легенду о Бэтмене в своей саге о городе Готэме, который в ближайшем будущем, спустя десять лет после того, как Бэтмен удалился от дел, пришел в полный упадок.</p>', 450, 15, 'Detective comics'),
(2003, 1001, 'Бетмен. Detective Comics. Жатва', 'Ядовитый Плющ вынуждена обратиться к властям за помощью…', '/img/BatmanHarvest.jpg', '<p>Ядовитый Плющ вынуждена обратиться к властям за помощью… Растения почему-то больше не хотят подчиняться ей и даже пытаются навредить. Во всём виноват чей-то злой умысел, или Плющ что-то скрывает? Ответ на этот вопрос сможет найти только Тёмный Рыцарь.</p>', 60, 1, 'Detective comics'),
(2004, 1010, 'Дедпул. Искусство войны', 'Книгу «Искусство войны» Сунь Цзы называют основополагающей работой в области военной стратегии и тактики.', '/img/WarCraft.jpeg', '<p>Книгу «Искусство войны» Сунь Цзы называют основополагающей работой в области военной стратегии и тактики. Она оказала влияние на военачальников и крупных предпринимателей на сотни лет вперёд. А значит, она стала достоянием общественности, и её совершенно точно может «слизать» Дэдпул!</p>\r\n\r\n<p>Но как же он планирует обеспечить своей версии продажи больше, чем у оригинала? Приложит все силы, чтобы к моменту её публикации мир погряз в войне! Но вскоре Дэдпул узнает, что развязать войну гораздо проще, чем ею управлять! И вот, Локи пленил Пула и подготовился к завоеванию Земли! К счастью, Дэдпул разбирается в искусстве войны, верно? (Разбирается, в этом же и есть вся суть. Данный комикс — военное пособие от Дэдпула.)</p>\r\n\r\n\r\n<p>Уничтожит ли Землю война Дэдпула, сделает ли она его самым продаваемым автором — или и то, и другое?</p>', 200, 4, 'Marvel'),
(2005, 1010, 'Дедпул и его секретные войны', 'Приготовьтесь – авторский коллектив комикса "Дэдпул уничтожает Литературу"', '/img/sikretWar.jpeg', '<p>Всё так, тут речь пойдёт о том самом кроссовере 1984 года! Но погодите, ведь Дэдпула в той серии не было, так? А вот и был! Приготовьтесь – авторский коллектив комикса "Дэдпул уничтожает Литературу" расскажет вам шокирующую правду о том, какую важную роль Болтливый Наёмник сыграл в Мире Битв Потустороннего! Об этом не помнят даже остальные герои Marvel! Теперь без Дэдпула не обойдётся ни одно ключевое событие Секретных Войн – он был рядом и когда Доктор Дум стал всемогущим, и когда Халк держал гору! Вокруг бушует хаос… появляются… и исчезают новые костюмы, а ещё у Уэйда теперь есть свой отпадный секретный щит! Скоро вы узнаете, как на самом деле закончились те самые Секретные Войны… и как убойный убийца спас вселенную!</p>', 175, 6, 'Marvel'),
(2006, 1010, 'Дэдпул vs Громовержцы', 'Безумный Болтливый Наёмник исполняет свой самый сумасшедший план: полномасштабное наступление на Нормана Озборна!', '/img/DeadPoolVS.jpg', '<p>Безумный Болтливый Наёмник исполняет свой самый сумасшедший план: полномасштабное наступление на Нормана Озборна! Пока всеми любимый упрямый убийца пробивается к вершине Башни Мстителей, Озборн вынужден остановить его любой ценой, чтобы спасти свою шкуру, а конкретно — задействовать совершенно новую команду кровожадных секретных бойцов Громовержцев! Дэдпул поймал Громовержцев на мушку, как и они поймали его!</p>', 175, 2, 'Marvel'),
(2007, 1002, 'Удивительный Человек-Паук. Заговор клонов', 'СМЕРТИ БОЛЬШЕ НЕТ!', '/img/conOfTheClone.jpg', '<p>СМЕРТИ БОЛЬШЕ НЕТ! БУДУЧИ ЧЕЛОВЕКОМ ПАУКОМ, Питер Паркер потерял многих — любимых, друзей и даже врагов. Но что случится, если те, по кому он скорбил, вдруг восстанут из могил? Вы узнаете это, когда он встретится с близкими, которых уже и не мечтал увидеть вновь — равно как и с опасными врагами, которых он предпочёл бы считать мёртвыми. Потому что на каждую Гвен Стейси найдётся Доктор Осьминог! Гений, стоящий за этими воскрешениями — злодей, что уже однажды клонировал Человека-Паука: безумный Шакал! И пока команда героев в лице Шёлк, Мародёра и Алого Паука пытается что-то предпринять, Паучок сталкивается с самой большой проблемой в своей жизни. Если Шакал победит смерть, будет ли жизнь прежней?</p>', 845, 53, 'Marvel'),
(2008, 1002, 'Человек-Паук. Последняя охота Крэйвена', 'Роман о смерти Человека-паука!', '/img/lastHunt.jpg', '<p>Роман о смерти Человека-паука! Давний враг Питера Паркера Сергей Кравинов, потомок русских аристократов, прирождённый охотник, начинает свою последнюю схватку. Его жертва – Человек-Паук. Но Кравинов не остановится, заполучив свой трофей, он намерен влезть в шкуру Паука, как делал с другими своими жертвами, изучить его повадки и занять его место. Все новые комиксы о Невероятном Человеке-пауке основаны на этой трагической истории.</p>', 155, 5, 'Marvel'),
(2009, 1004, 'Доктор Стрендж. Клятва', 'Доктор Стефан Стрэндж должен расследовать самое важное мистическое дело за всю его карьеру', '/img/Kljatva.jpg', '<p>Доктор Стефан Стрэндж должен расследовать самое важное мистическое дело за всю его карьеру — попытку покушения на его собственную жизнь! Чтобы раскрыть эту тайну Стрэнджу придется совершить удивительное путешествие через параллельные реальности и преступный мир Нью-Йорка. Ситуация осложняется тем, что лучший друг Стрэнджа — его преданный ученик Вонг — находится на краю гибели.</p>', 290, 2, 'Marvel'),
(2010, 1006, 'Звездные войны. Дарт Мол. Смертельный приговор', 'Дарт Мол, тёмный владыка ситхов, ученик Дарта Сидиуса, был повержен.', '/img/SmertnyjPrigovor.jpg', '<p>Дарт Мол, тёмный владыка ситхов, ученик Дарта Сидиуса, был повержен Оби-Ваном Кеноби в схватке на планете Набу («Звёздные Войны: Эпизод I. Скрытая угроза»). Но от ситха не так-то легко избавиться! Собрав весть свой гнев, всю свою ярость, Мол выжил. Он приобрёл кибернетические ноги, объединился со своим братом Саважем Опрессом и намеревается отомстить джедаям.</p>', 250, 13, 'Disney'),
(2151, 1007, 'asswabvaw', 'asawava', 'awbasawgasa', 'wagbsab', 21215, 0, '');
...
--
-- База данных: `hutzkerbase`
--
CREATE DATABASE `hutzkerbase` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hutzkerbase`;
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  PRIMARY KEY (`id_category`),
  KEY `id_category` (`id_category`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Категории товаров' AUTO_INCREMENT=1010 ;
...
(1000, 'Процессоры'),
(1001, 'Материнские платы'),
(1002, 'Видеокарты'),
(1003, 'Модули памяти'),
(1004, 'Жесткие диски/SSD'),
(1005, 'Блоки питания'),
(1006, 'Системы охлаждения'),
(1007, 'Звуковые карты'),
(1008, 'Корпуса'),
(1009, 'Сетевые карты');
...
INSERT INTO `products` (`id_product`, `id_category`, `name_product`, `characteristics`, `image`, `all_characteristics`, `price`, `num_of_sales`) VALUES
(2000, 1000, 'Процессор Intel® Core™ i7-6700K', '<p>Количество ядер: 4</p>\r\n<p>Количество потоков: 8</p>\r\n<p>Базовая тактовая частота процессора: 4.00 GHz</p>\r\n<p>Кэш-память: 8 MB SmartCache</p>\r\n', '/img/i7-6700K.jpg', '<p>Количество ядер: 4</p>\r\n<p>Количество потоков: 8</p>\r\n<p>Базовая тактовая частота процессора: 4.00 GHz</p>\r\n<p>Кэш-память: 8 MB SmartCache</p>\r\n<p>Типы памяти: DDR4-1866/2133, DDR3L-1333/1600 @ 1.35V</p>\r\n<p>Макс. пропускная способность памяти: 34.1 GB/s</p>\r\n', 8750, 10),
(2001, 1002, 'Видеокарта NVIDIA GEFORCE GTX 1060', '<p>Тип видеопамяти: GDDR5</p>\r\n<p>Объем видеопамяти: 6 ГБ</p>\r\n<p>Частота видеопамяти: 2000 МГц</p>\r\n<p>Потребляемая мощность: 120 Вт</p>', '/img/nvidia_geforce_gtx_1060.jpg', '<p>Тип видеопамяти: GDDR5</p>\r\n<p>Объем видеопамяти: 6 ГБ</p>\r\n<p>Частота видеопамяти: 2000 МГц</p>\r\n<p>Потребляемая мощность: 120 Вт</p>\r\n<p>Разрядность шины, бит: 192</p>\r\n<p>Тактовая частота: 1506 МГц</p>', 9260, 7),
(2002, 1001, 'Материнская плата Gigabyte GA-H61M-S2PV', '<p>Сокет: LGA1155</p>\n<p>Чипсет: Intel H61</p>\n<p>Слоты: DDR3 DIMM, 800-1333 МГц</p>\n<p>Разъемы SATA: 3 Гбит/с - 4</p>', '/img/article_3.jpg', '<p>Сокет: LGA1155</p>\r\n<p>Чипсет: Intel H61</p>\r\n<p>Слоты: DDR3 DIMM, 800-1333 МГц</p>\r\n<p>Разъемы SATA: 3 Гбит/с - 4</p>\r\n<p>Поддержка: EFI</p>\r\n<p>Максимальный объем памяти: 16 ГБ</p>', 2970, 4),
(2003, 1003, 'Оперативна память Kingston DDR2 4GB', '<p>Объем: 4 Гб</p>\r\n<p>Тип памяти: DDRII</p>\r\n<p>Частота: 800 MHz</p>\r\n<p>Стандарт памяти: PC2-6400</p>', '/img/article_4.jpg', '<p>Объем: 4 Гб</p>\r\n<p>Тип памяти: DDRII</p>\r\n<p>Частота: 800 MHz</p>\r\n<p>Стандарт памяти: PC2-6400</p>\r\n<p>Охолаждение: Нет</p>\r\n<p>Контроль парности: Non-ECC</p>', 450, 2),
(2004, 1004, '120 ГБ SSD-накопитель Palit UVS Series', '<p>Контроллер: Phison S11 (PS3111-S11)</p>\r\n<p>Кэш DRAM: 32 Мбайт</p>\r\n<p>Память: TLC 3D V-NAND</p>\r\n<p>Объем: 120 ГБ</p>\r\n\r\n', '/img/article_5.jpg', '<p>Контроллер: Phison S11 (PS3111-S11)</p>\r\n<p>Кэш DRAM: 32 Мбайт</p>\r\n<p>Память: TLC 3D V-NAND</p>\r\n<p>Объем: 120 ГБ</p>\r\n<p>Скорость чтения: 560 Мбайт/с<p>\r\n<p>Скорость записи: 375 Мбайт/с</p>	\r\n\r\n', 1650, 5),
(2005, 1005, 'Блок питания CROWN 400W ', '<p>Мощность (номинал): 400 Вт</p>\r\n<p>Разъемы для питания процессора: 1x 4 pin</p>\r\n<p>Разъемы для питания видеокарты: нет</p>\r\n<p>Количество разъемов 15-pin SATA: 2</p>', '/img/article_6.jpg', '<p>Мощность (номинал): 400 Вт</p>\r\n<p>Разъемы для питания процессора: 1x 4 pin</p>\r\n<p>Разъемы для питания видеокарты: нет</p>\r\n<p>Количество разъемов 15-pin SATA: 2</p>\r\n<p>Система охлаждения: активная</p>\r\n<p>Отстегивающиеся кабели: нет</p>', 970, 3),
(2006, 1000, 'Процессор Intel® Core™ i9-9960X серии X', '<p>Количество ядер: 16</p>\n<p>Количество потоков: 32</p>\n<p>Базовая тактовая частота процессора: 3.10 GHz</p>\n<p>Кэш-память: 22 MB SmartCache</p>', '/img/i9-9960X.png', '<p>Количество ядер: 16</p>\n<p>Количество потоков: 32</p>\n<p>Базовая тактовая частота процессора: 3.10 GHz</p>\n<p>Кэш-память: 22 MB SmartCache</p>\n<p>Типы памяти: DDR4-2666</p>\n<p>Макс. пропускная способность памяти: 34.1 GB/s</p>\n', 65000, 2),
(2007, 1000, 'Процессор AMD Ryzen 7 2700X', '<p>Количество ядер: 8</p>\n<p>Количество потоков: 16</p>\n<p>Базовая тактовая частота процессора: 4.3 ГГц</p>\n<p>Кэш-память: 16 Мб</p>', '/img/AMD_Ryzen7_ 2700X.jpg', '<p>Количество ядер: 8</p>\n<p>Количество потоков: 16</p>\n<p>Базовая тактовая частота процессора: 4.3 ГГц</p>\n<p>Кэш-память: 16 Мб</p>\n<p>Типы памяти: DDR4</p>\n<p>Макс. пропускная способность памяти: 16 GB/s</p>\n', 8990, 4),
(2008, 1002, 'Видеокарта AMD Radeon Pro WX 7100', '<p>Тип видеопамяти: GDDR5</p>\n<p>Объем видеопамяти: 8 Гб</p>\n<p>Частота видеопамяти: 7000 МГц</p>\n<p>Потребляемая мощность: 130 Вт</p>', '/img/AMD_Radeon_Pro_WX_7100.jpg', '<p>Тип видеопамяти: GDDR5</p>\n<p>Объем видеопамяти: 8 Гб</p>\n<p>Частота видеопамяти: 7000 МГц</p>\n<p>Потребляемая мощность: 130 Вт</p>\n<p>Разрядность шины, бит: 192</p>\n<p>Тактовая частота: 1506 МГц</p>', 13760, 6);
--
...
('def', 'cmsdb', 'basket', 'id_product', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'basket', 'suma', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'basket', 'id_basket', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cmsdb', 'category', 'id_category', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cmsdb', 'category', 'name', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'id_order', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'id_user', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'id_basket', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'delivery_type', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'order_price', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'payment_method', 6, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'orders', 'date', 7, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'id_product', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'id_category', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'name_product', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'characteristics', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'image', 5, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'all_characteristics', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'price', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'num_of_sales', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'products', 'type_of_comics', 9, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'users', 'id_user', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cmsdb', 'users', 'name', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'users', 'login', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'users', 'password', 4, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'cmsdb', 'users', 'id_basket', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'categories', 'id_category', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'categories', 'name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'id_product', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'id_category', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'name_product', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'characteristics', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'image', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'all_characteristics', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'price', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'hutzkerbase', 'products', 'num_of_sales', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
...
('INNODB_BUFFER_POOL_PAGES_FREE', '7907'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '4549'),
('INNODB_BUFFER_POOL_READS', '285'),
...
('INNODB_DATA_READ', '8949760'),
('INNODB_DATA_READS', '423'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '4441'),
('UPTIME_SINCE_FLUSH_STATUS', '4441');
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-ENQD2JT.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-ENQD2JT.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-ENQD2JT.err'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-ENQD2JT-slow.log'),
...
('def', 'cmsdb', 'PRIMARY', 'def', 'cmsdb', 'basket', 'id_basket', 1, NULL, NULL, NULL, NULL),
('def', 'cmsdb', 'PRIMARY', 'def', 'cmsdb', 'category', 'id_category', 1, NULL, NULL, NULL, NULL),
('def', 'cmsdb', 'PRIMARY', 'def', 'cmsdb', 'orders', 'id_order', 1, NULL, NULL, NULL, NULL),
('def', 'cmsdb', 'PRIMARY', 'def', 'cmsdb', 'products', 'id_product', 1, NULL, NULL, NULL, NULL),
('def', 'cmsdb', 'PRIMARY', 'def', 'cmsdb', 'users', 'id_user', 1, NULL, NULL, NULL, NULL),
('def', 'hutzkerbase', 'PRIMARY', 'def', 'hutzkerbase', 'categories', 'id_category', 1, NULL, NULL, NULL, NULL),
('def', 'hutzkerbase', 'PRIMARY', 'def', 'hutzkerbase', 'products', 'id_product', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-11-26 06:53:07', '2018-11-26 06:53:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2018-11-26 06:53:07', NULL, NULL, NULL, '', '', NULL),
('def', 'cmsdb', 'basket', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-10-22 03:02:50', NULL, NULL, NULL, '', '', NULL),
('def', 'cmsdb', 'category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2018-10-22 02:58:17', NULL, NULL, NULL, '', '', NULL),
('def', 'cmsdb', 'orders', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-10-22 03:20:55', NULL, NULL, NULL, '', '', NULL),
('def', 'cmsdb', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 1489, 16384, NULL, 16384, 0, '2018-10-22 02:57:34', NULL, NULL, NULL, '', '', NULL),
('def', 'cmsdb', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2018-10-22 03:14:01', NULL, NULL, NULL, '', '', NULL),
('def', 'hutzkerbase', 'categories', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 16384, 0, '2018-10-24 13:57:10', NULL, NULL, NULL, '', '', NULL),
('def', 'hutzkerbase', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 81920, 0, '2018-11-25 08:18:05', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2018-10-29 05:05:04', '2012-05-15 12:23:07', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-05-15 12:23:05', '2018-11-25 07:26:38', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2018-10-28 06:57:38', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_bookmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_column_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_history', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_pdf_pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 248, 248, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2018-11-25 08:17:51', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 224, 281474976710655, 9216, 224, '2012-06-11 22:55:25', '2018-10-25 04:47:44', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_uiprefs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 56, 92, 281474976710655, 7168, 36, '2012-06-11 22:55:25', '2018-10-16 18:42:12', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_tracking', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 56, 56, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2018-10-19 11:24:08', NULL, NULL, '', '', NULL);
...
(106, 'root', 'localhost:2423', 'hutzkerbase', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(105, 'root', 'localhost:2422', NULL, 'Sleep', 4, '', NULL);
...
('def', 'cmsdb', 'utf8', 'utf8_general_ci', NULL),
('def', 'hutzkerbase', 'utf8', 'utf8_general_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '4906'),
('INNODB_BUFFER_POOL_READS', '285'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1'),
('INNODB_DATA_FSYNCS', '7'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '4443'),
('UPTIME_SINCE_FLUSH_STATUS', '4443');
...
('def', 'cmsdb', 'basket', 0, 'cmsdb', 'PRIMARY', 1, 'id_basket', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'basket', 1, 'cmsdb', 'id_product', 1, 'id_product', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'category', 0, 'cmsdb', 'PRIMARY', 1, 'id_category', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'orders', 0, 'cmsdb', 'PRIMARY', 1, 'id_order', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'orders', 1, 'cmsdb', 'id_user', 1, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'orders', 1, 'cmsdb', 'id_user', 2, 'id_basket', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'products', 0, 'cmsdb', 'PRIMARY', 1, 'id_product', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'products', 1, 'cmsdb', 'id_category', 1, 'id_category', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'users', 0, 'cmsdb', 'PRIMARY', 1, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cmsdb', 'users', 1, 'cmsdb', 'id_basket', 1, 'id_basket', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'categories', 0, 'hutzkerbase', 'PRIMARY', 1, 'id_category', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'categories', 1, 'hutzkerbase', 'id_category', 1, 'id_category', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'products', 0, 'hutzkerbase', 'PRIMARY', 1, 'id_product', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'products', 1, 'hutzkerbase', 'id_category', 1, 'id_category', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'products', 1, 'hutzkerbase', 'id_category_2', 1, 'id_category', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'products', 1, 'hutzkerbase', 'id_category_3', 1, 'id_category', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'products', 1, 'hutzkerbase', 'id_category_4', 1, 'id_category', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hutzkerbase', 'products', 1, 'hutzkerbase', 'id_category_5', 1, 'id_category', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-11-26 06:53:08', '2018-11-26 06:53:08', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2018-11-26 06:53:08', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'cmsdb', 'basket', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 8388608, 1, '2018-10-22 03:02:50', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'cmsdb', 'category', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 8388608, 1011, '2018-10-22 02:58:17', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'cmsdb', 'orders', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 8388608, 1, '2018-10-22 03:20:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'cmsdb', 'products', 'BASE TABLE', 'InnoDB', 10, 'Compact', 11, 1489, 16384, 0, 16384, 8388608, 2152, '2018-10-22 02:57:34', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'cmsdb', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 8388608, 1, '2018-10-22 03:14:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'hutzkerbase', 'categories', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 16384, 8388608, 1010, '2018-10-24 13:57:10', NULL, NULL, 'utf8_general_ci', NULL, '', 'Категории товаров'),
('def', 'hutzkerbase', 'products', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 81920, 8388608, 2009, '2018-11-25 08:18:05', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2018-10-29 05:05:04', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:05', '2018-11-25 07:26:38', NULL, 'utf8_general_ci', NULL, '', 'Events'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2018-10-28 06:57:38', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
('def', 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
('def', 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 248, 248, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2018-11-25 08:17:51', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
('def', 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 224, 281474976710655, 9216, 224, NULL, '2012-06-11 22:55:25', '2018-10-25 04:47:44', NULL, 'utf8_bin', NULL, '', 'Relation table'),
('def', 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
('def', 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_table_uiprefs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 56, 92, 281474976710655, 7168, 36, NULL, '2012-06-11 22:55:25', '2018-10-16 18:42:12', NULL, 'utf8_bin', NULL, '', 'Tables'' UI preferences'),
('def', 'phpmyadmin', 'pma_tracking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 22:55:26', NULL, 'utf8_bin', NULL, 'row_format=COMPACT', 'Database changes tracking for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 56, 56, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2018-10-19 11:24:08', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('def', 'cmsdb', 'PRIMARY', 'cmsdb', 'basket', 'PRIMARY KEY'),
('def', 'cmsdb', 'PRIMARY', 'cmsdb', 'category', 'PRIMARY KEY'),
('def', 'cmsdb', 'PRIMARY', 'cmsdb', 'orders', 'PRIMARY KEY'),
('def', 'cmsdb', 'PRIMARY', 'cmsdb', 'products', 'PRIMARY KEY'),
('def', 'cmsdb', 'PRIMARY', 'cmsdb', 'users', 'PRIMARY KEY'),
('def', 'hutzkerbase', 'PRIMARY', 'hutzkerbase', 'categories', 'PRIMARY KEY'),
('def', 'hutzkerbase', 'PRIMARY', 'hutzkerbase', 'products', 'PRIMARY KEY'),
...
('root', '[{"db":"hutzkerbase","table":"products"},{"db":"cmsdb","table":"products"},{"db":"hutzkerbase","table":"categories"},{"db":"cmsdb","table":"category"},{"db":"cmsamongusdb","table":"categories"},{"db":"cmsamongusdb","table":"products"}]');
...
('root', 'hutzkerbase', 'categories', '[]', '2018-10-16 18:42:11');
...
('root', '2018-10-19 11:23:46', '{"lang":"ru","collation_connection":null}');
